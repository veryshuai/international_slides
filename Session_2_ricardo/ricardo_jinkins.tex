...
\item
  ...
  \begin{itemize}
        ...
        \begin{itemize}
            \item Review
            \item Relative Wages and productivity
            \item Ricardo with capital
...
\begin{frame}{David Ricardo}
    ...
    \begin{center}
    \includegraphics[scale=0.27]{Ricardo_portrait.jpg}
    \end{center}

    {\tiny source: http://en.wikipedia.org/wiki/David\_Ricardo}
    \note{Ricardo 
    
        1. died at 49 years old in 1823, 

        2. Richest theoretical economist in history, 

        3. Not an academic, he was a stockbroker, made his fortune manipulating the market at time of Waterloo, 

        4. Bought himself a seat in the house of commons. 

        5. Still had time to become the first modern economist}
...
\frame[plain]{\includegraphics[page=1,width=\textwidth]{PPF_pearson_snippet.pdf}}
...
\frame[plain]{\includegraphics[page=1,width=\textwidth]{Numerical_example_pearson_snippet.pdf}}
\frame[plain]{\includegraphics[page=2,width=\textwidth]{Numerical_example_pearson_snippet.pdf}}
\frame[plain]{\includegraphics[page=3,width=\textwidth]{Numerical_example_pearson_snippet.pdf}}
\frame[plain]{\includegraphics[page=4,width=\textwidth]{Numerical_example_pearson_snippet.pdf}}
\frame[plain]{\includegraphics[page=5,width=\textwidth]{Numerical_example_pearson_snippet.pdf}}
\frame[plain]{\includegraphics[page=6,width=\textwidth]{Numerical_example_pearson_snippet.pdf}}
\frame[plain]{\includegraphics[page=7,width=\textwidth]{Numerical_example_pearson_snippet.pdf}}
\frame[plain]{\includegraphics[page=8,width=\textwidth]{Numerical_example_pearson_snippet.pdf}}
\frame[plain]{\includegraphics[page=9,width=\textwidth]{Numerical_example_pearson_snippet.pdf}}
\frame[plain]{\includegraphics[page=10,width=\textwidth]{Numerical_example_pearson_snippet.pdf}}
