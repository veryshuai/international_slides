...
\frame[plain]{\includegraphics[page=37,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=39,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=41,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=32,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=43,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=44,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=48,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=56,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=57,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=58,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=59,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=60,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=61,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=62,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=63,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=64,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=65,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=66,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=69,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=70,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=72,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=75,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=76,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=77,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=80,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=81,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=83,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=86,width=\textwidth]{trade_policy_one.pdf}}
\frame[plain]{\includegraphics[page=88,width=\textwidth]{trade_policy_one.pdf}}
