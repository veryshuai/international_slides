...
\frame[plain]{\includegraphics[page=32,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=34,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=36,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=40,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=41,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=45,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=46,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=48,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=49,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=50,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=51,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=52,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=53,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=54,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=56,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=58,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=60,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=61,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=62,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=63,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=64,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=65,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=66,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=69,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=70,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=73,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=74,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=75,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=76,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=77,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=78,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=79,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=80,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=81,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=82,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=85,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=87,width=\textwidth]{short_run_exchange.pdf}}
\frame[plain]{\includegraphics[page=89,width=\textwidth]{short_run_exchange.pdf}}
...
\frame{
    \frametitle{Goals of Macroeconomic Policies: Full employment}
\begin{itemize}
    \item Suppose some shock causes temporarily low demand 
    \begin{itemize}
        \item Harm from unemployment is clear
    \end{itemize}
    \item Suppose some shock causes temporarily high demand 
    \begin{itemize}
        \item Quick depreciation of capital
        \item Contractual agreements cause too little leisure
    \end{itemize}
\end{itemize}
}

\frame{
    \frametitle{Goals of Macroeconomic Policies: Price stability}
\begin{itemize}
    \item Unexpected inflation
    \begin{itemize}
        \item Transfer to borrowers
    \end{itemize}
    \item Unexpected deflation
    \begin{itemize}
        \item Transfer to lenders
    \end{itemize}
    \item Both bad
\end{itemize}
}
...
\frame{
\frametitle{Goals of Macroeconomic Policies: Reasonable Current Account Deficit}
\begin{itemize}
    \item We do want countries to borrow and lend: smooth consumption
    \item Too much borrowing:
    \begin{itemize}
        \item Countries find it hard to meet debt obligations
        \item Countries find further funding hard to come by 
    \end{itemize}
    \item Too much lending:
    \begin{itemize}
        \item Vulnerable to default
        \item Capital leaving the country, spillovers
    \end{itemize}
\end{itemize}
}

\frame[plain]{
\frametitle{The Policy Trilemma for Open Economies}
\begin{figure}
	\centering
		\includegraphics[scale=0.25]{trilemma.png}
\end{figure}
}

\frame[plain]{
\frametitle{Internal Balance (II), External Balance (XX), and the "Four Zones of Economic Discomfort"}
\begin{figure}
	\centering
		\includegraphics[scale=0.20]{economic_discomfort.png}
	\label{fig:11}
\end{figure}
}
